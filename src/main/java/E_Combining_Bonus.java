public class E_Combining_Bonus {
  ...
  public static void main(String[] args) {
    ...
    // Combination 2
    //
    // Implementeer een whileloop de nummers in de lijst optelt tot het resultaat groter is dan 400.
    // Je hebt ook een index nodig voor de array (int index = 0;). Deze index kun je in de while loop muteren.
  }
}
